                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    ...
                                                                    <img alt="Taghazout Market Logo"
                                                                        src={{ $message->embed(public_path('logo.png')) }}
                                                                        style="display: block; height: auto; border: 0; width: 46px; max-width: 100%;"
                                                                        title="Taghazout Market Logo" width="46" />
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span
                                                                                style="font-size:30px;color:#2b303a;"><strong>Thank
                                                                                    you for the order</strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: justify; mso-line-height-alt: 22.5px;">
                                                                            <span
                                                                                style="color:#808389;font-size:15px;">Thank
                                                                                you for your order from Taghazout
                                                                                Market! We greatly appreciate your trust
                                                                                in us. Our dedicated team is working
                                                                                tirelessly to process and fulfill your
                                                                                purchase promptly. Rest assured, your
                                                                                items will be carefully prepared and
                                                                                shipped with utmost care.</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                            ...
                                            <tr>
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:35px;padding-top:35px;">
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 21px;">
                                                                            <span style="color:#aaacb0;"><strong><span
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span
                                                                                style="font-size:20px;color:#2b303a;"><strong>#{{ $order->id }}</strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:25px;padding-top:35px;">
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 21px;">
                                                                            <span style="color:#aaacb0;"><strong><span
                                                                                        style="font-size:12px;">PRODUCTS
                                                                                        ORDERED
                                                                                        ({{ count($order->orderItems) }})</span></strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                            ...
                            @foreach ($order->orderItems as $orderItem)
                                <tr>
                                    <td>
                                        <table align="center" border="0" cellpadding="0" cellspacing="0"
                                            class="row-content stack" role="presentation"
                                            style="mso-table-lspace: 0pt;margin-bottom: 50px;mso-table-rspace: 0pt; background-color: #fff; color: #000000; width: 640px;"
                                            width="640">
                                            <tbody>
                                                <tr>
                                                    <td class="column column-1"
                                                            ...
                                                            <tr>
                                                                <td class="pad"
                                                                    ...
                                                                    <div align="left" class="alignment"
                                                                        style="line-height:10px">
                                                                        <img alt="Product Image" {{-- src={{ $message->embed(public_path('products/' . $orderItem->product->ProductImages[0]['image'])) }} --}}
                                                                            src={{ $orderItem->product->ProductImages[0]['image'] }}
                                                                            style="display: block; height: 200px; border: 0; width: 200px; max-width: 100%;"
                                                                            title="Product Image" width="260" />
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <td class="column column-2"
                                                        ...
                                                        <table border="0" cellpadding="10" cellspacing="0"
                                                            class="divider_block desktop_hide block-1"
                                                            role="presentation"
                                                                ...
                                                                <td class="pad">
                                                                    <div style="font-family: sans-serif">
                                                                        <div class=""
                                                                            style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
                                                                            <p
                                                                                style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 30px;">
                                                                                <span
                                                                                    style="font-size:20px;color:#2b303a;"><strong>{{ $orderItem->product->name }}<br />${{ $orderItem->product->selling_price }}</strong></span>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                    ...
                                                                    <div style="font-family: sans-serif">
                                                                        <div class=""
                                                                            ...
                                                                            <p
                                                                                style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 21px;">
                                                                                <span
                                                                                    style="color:#808389;">{{ $orderItem->product->description }}</span>
                                                                            </p>
                                                                            <p
                                                                            ...
                                                                            <p
                                                                                style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 21px;">
                                                                                <span style="color:#808389;">Quantity:
                                                                                    {{ $orderItem->quantity }}</span>
                                                                            </p>
                                                                            <p
                                                                                style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 21px;">
                                                                                <span style="color:#808389;">Price:
                                            ...
                                            <tr>
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:15px;padding-top:35px;">
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
                                                                        <p
                                                            ...
                                                            <td class="pad">
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 23.400000000000002px;">
                                                                            <span
                                                                                style="color:#2b303a;font-size:13px;">Payment
                                                                                Method</span>
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 23.400000000000002px;">
                                                                            <span
                                                                                style="color:#2b303a;font-size:13px;">Subtotal</span>
                                                                        </p>
                                                                        {{-- @if ($order->coupon_discount)
                                                                            <p
                                                                                style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 23.400000000000002px;">
                                                                                <span
                                                                                    style="color:#2b303a;font-size:13px;">Coupon</span>
                                                                            </p>
                                                                        @endif --}}
                                                            ...
                                                            <td class="pad" style="padding-top:15px;">
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 21.6px; color: #555555; line-height: 1.8;">
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 36px;">
                                                            ...
                                                            <td class="pad">
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 21.6px; color: #555555; line-height: 1.8;">
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: right; mso-line-height-alt: 23.400000000000002px;">
                                                                            <span
                                                                                style="color:#2b303a;font-size:13px;">
                                                                                {{ $order->payment_mode }} </span>
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: right; mso-line-height-alt: 23.400000000000002px;">
                                                                            <span
                                                                                style="color:#2b303a;font-size:13px;">$128</span>
                                                                        </p>
                                                                        {{-- @if ($order->coupon_discount)
                                                                            <p
                                                                                style="margin: 0; font-size: 14px; text-align: right; mso-line-height-alt: 23.400000000000002px;">
                                                                                <span
                                                                                    style="color:#2b303a;font-size:13px;">-$4.99</span>
                                                                            </p>
                                                                        @endif --}}
                                                            ...
                                                            <td class="pad" style="padding-top:15px;">
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 21.6px; color: #555555; line-height: 1.8;">
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: right; mso-line-height-alt: 36px;">
                                                                            <span style="font-size:20px;"><strong><span
                                                                                        style="color:#2b303a;">$128</span></strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        class="row-content stack" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000000; background-color: #ffffff; width: 640px;"
                                        width="640">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-top:40px;width:200px;padding-right:0px;padding-left:0px;">
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px">
                                                                    <img alt="Taghazout Market Logo"
                                                                        src={{ $message->embed(public_path('logo.png')) }}
                                                                        style="display: block; height: auto; border: 0; width: 46px; max-width: 100%;"
                                                                        title="Taghazout Market Logo"
                                                                        width="46" />
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        style="font-size: 12px; mso-line-height-alt: 21.6px; color: #555555; line-height: 1.8; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
                                                                        <p
                                                                            style="margin: 0; text-align: justify; mso-line-height-alt: 23.400000000000002px;">
                                                                            <span style="font-size:13px;">Welcome to
                                                                                Taghazout Market, the premier online
                                                                                store for all your shopping needs! We
                                                                                pride ourselves on offering a curated
                                                                                selection of high-quality products that
                                                                                cater to your unique tastes and
                                                                                preferences. Whether you're searching
                                                                                for trendy fashion apparel, exquisite
                                                                                home decor, cutting-edge electronics, or
                                                                                artisanal handicrafts, we've got you
                                                                                covered. </span>
                                                                        </p>
                                                                    </div>
                                                                </div>
